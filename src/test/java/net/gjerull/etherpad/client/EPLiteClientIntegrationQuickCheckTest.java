...
public class EPLiteClientIntegrationQuickCheckTest {
	...
	@Property
	public void create_author(String authorName) throws Exception {

		new MockServerClient("localhost", 9001).when(HttpRequest.request()
				.withMethod("POST").withPath("/api/1.2.13/createAuthor?")
				.withBody(
						"apikey=a04f17343b51afaa036a7428171dd873469cd85911ab43be0503d29d2acbbd58&name="
		...
		String response = "{\"code\":0,\"message\":\"ok\",\"data\":\""
				+ authorName + "\"}";
		new MockServerClient("localhost", 9001).when(HttpRequest.request()
	...
	@Property
	public void create_pad_with_random_text(String keep)
	...
	@Property
	public void chat_whit_random_messages(String message)
			throws UnsupportedEncodingException {
		...
		new MockServerClient("localhost", 9001).when(HttpRequest.request()
				...
				.withBody(
						"apikey=a04f17343b51afaa036a7428171dd873469cd85911ab43be0503d29d2acbbd58&padID=integration-test-pad-1&text="
		...
		String user = "user1";
		Map response = client.createAuthorIfNotExistsFor(user,
