 ...
 * <br />
 * <code>
 * EPLiteClient api = new EPLiteClient
 * ("http://etherpad.mysite.com","FJ7jksalksdfj83jsdflkj");
 * <br />
...
public class EPLiteClient {
	...
	/**
	 * Type of encoding by default.
	 */
	private static final String DEFAULT_ENCODING = "UTF-8";

	/**
	 * Client connection to the EPLite server.
	 */
	 ...
	 * @return Map with groupID
	 */
	public Map createGroupIfNotExistsFor(final String groupMapper) {
	 ...
	 * @return Map
	 */
	public Map listPads(final String groupID) {
		Map<String, Object> args = new HashMap<>();
		args.put("groupID", groupID);
	 ...
	 * @return Map
	 */
	public Map createGroupPad(final String groupID, final String padName) {
		Map<String, Object> args = new HashMap<>();
		args.put("groupID", groupID);
	...
	// Authors
	// These authors are bound to the attributes the users
	 ...
	 * @return Map with sessionID
	 */
	public Map createSession(String groupID, String authorID,
			int sessionDuration) {
